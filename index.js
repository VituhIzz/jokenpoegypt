...
function jogar(escolha){
	...
	if ((jogadorEscolha == 1) && (computadorEscolha == 1)) {
		ganhador = 0;
		document.getElementById('mensagens').innerHTML = '<h2><font color="#F2B138">Empate!</font></h2>';
	}
	else if ((jogadorEscolha == 1) && (computadorEscolha == 2)) {
		ganhador = 2;
		document.getElementById('mensagens').innerHTML = '<h2><font color="#EE0000">Perdeu!</font></h2>';
	}
	else if ((jogadorEscolha == 1) && (computadorEscolha == 3)) {
		ganhador = 1;
		document.getElementById('mensagens').innerHTML = '<h2><font color="#307516">Venceu!</font></h2>';
	}
